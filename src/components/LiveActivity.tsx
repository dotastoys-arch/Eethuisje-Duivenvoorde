      ...
      <AnimatePresence>
        {activity && (
          <motion.div
            ...
            className="bg-brand-olive text-white px-4 py-2 rounded-full shadow-2xl flex items-center gap-2 text-xs font-medium whitespace-nowrap border border-white/20"
          >
            <span className="bg-white/20 p-1 rounded-full">{activity.icon}</span>
            {activity.text}
          </motion.div>
        )}
      </AnimatePresence>
